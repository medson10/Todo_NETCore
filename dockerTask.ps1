...
.PARAMETER Clean
Removes the image todo_netcore and kills all containers based on that image.
...
Build a Docker image named todo_netcore
#>
...
$imageName="todo_netcore"
$projectName="todonetcore"
$serviceName="todo_netcore"
